      ...
      <section>
        ...
        <div className="h-fit pt-24 p-6 bg-black text-white">
          <div className="flex flex-col items-center ">
            ...
            <div
              className="flex flex-col mt-[2rem] md:flex-row rounded-xl justify-between w-full md:w-[90%] font-clash bg-red-800/25"
              ref={card}
            >
              <Image
                src={props.image}
              ...
              <div className="relative flex flex-col justify-between w-full px-2 md:p-8 gap-16">
                ...
                <button
                  className="relative bottom-5 bg-white text-black w-full rounded-full p-2 font-medium hover:bg-red-700 hover:text-white transition duration-300 ease-in-out"
                  onClick={() => {
            ...
            {props.rulehead == "" ? null : (
              <div className="font-clash flex flex-col mt-[2rem] p-3 md:p-6 rounded-xl justify-between w-full md:w-[90%] bg-red-800/25">
